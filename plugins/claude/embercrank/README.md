...
This package is the local Embercrank connector for Claude Code. It contains host integration, protocol validation and bounded local execution protections. The managed routing policy, model catalogue, entitlement logic and learning policy remain on Embercrank's service.
