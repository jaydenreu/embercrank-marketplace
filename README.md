...
```text
codex plugin marketplace add jaydenreu/embercrank-marketplace --ref v0.1.0-beta.9
...
```text
claude plugin marketplace add jaydenreu/embercrank-marketplace@v0.1.0-beta.9
